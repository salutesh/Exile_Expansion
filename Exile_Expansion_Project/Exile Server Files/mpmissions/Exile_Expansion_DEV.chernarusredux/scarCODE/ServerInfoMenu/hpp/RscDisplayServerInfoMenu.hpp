class RscDisplayServerInfoMenu
{
   ...
   {
      access = 0;
      colorBackground[] = {0.133,0.145,0.149,0.85m};
   ...
   class RscControlsGroupNoHscroll
   {
      ...
      class HScrollbar
      {
         ...
         color[] = {0.984,0.988,0.996,1};
         colorActive[] = {0.984,0.988,0.996,1};
         colorDisabled[] = {0.984,0.988,0.996,0.3};
         height = 0;
         scrollSpeed = 0.06;
         shadow = 0;
   ...
   class ServerInfoText : RscText
   {
      ...
      style = 0;
      text = "";
      tooltipColorBox[] = {0.984,0.988,0.996,0.1};
      tooltipColorShade[] = {0,0,0,0.65};
      tooltipColorText[] = {0.984,0.988,0.996,0.9};
      type = 0;
   };
   class RscListBox
   {
      ...
      style = 16;
      tooltipColorBox[] = {0.95,0.95,0.95,1};
      tooltipColorShade[] = {0,0,0,0.65};
      tooltipColorText[] = {0.984,0.988,0.996,1};
      type = 5;
   };
   class controls
   {
      class serverTitle:ServerInfoText
      {
         ...
         colorBackground[] = {0.133,0.145,0.149,0.85};
         colorText[] = {0.984,0.988,0.996,0.95};
         font = "PuristaBold";
         idc = 0;
         sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 2)";
      };
      class serverAddress:ServerInfoText
      {
         x = 0 * GUI_GRID_W + GUI_GRID_X;
      ...
      class serverUptime:ServerInfoText
      {
      ...
      class allPlayers:ServerInfoText
      {
      ...
      class restartSchedule:ServerInfoText
      {
      ...
      class menuTitle:ServerInfoText
      {
         x = 0 * GUI_GRID_W + GUI_GRID_X;
         ...
         colorBackground[] = {0.886,0.255,0.259,0.85};
         colorText[] = {0.984,0.988,0.996,0.95};
         font = "PuristaLight";
         idc = -1;
         shadow = 0;
