class RscDisplayRestartWarnings
{
   ...
   class controls
   {
      class txtCaution:RestartText
      {
         ...
         colorBackground[] = {0.886,0.255,0.259,0.75};
         colorText[] = {0.984,0.988,0.996,1};
         fade = 1;
         font = "PuristaMedium";
         text = "WARNING";
      };
      class txtMinutes:RestartText
      {
         x = 0.2925 * safezoneW + safezoneX;
         ...
         colorBackground[] = {0.153,0.153,0.176,0.75};
         colorText[] = {0.984,0.988,0.996,1};
         //fade = 1;
         font = "PuristaBold";
         text = "99";
