private["_vehicleID","_data","_position","_vectorDirection","_vectorUp","_pinCode","_texture","_ammo","_vehicleObject","_lock","_unlockInSafeZonesAfterRestart","_isLocked","_hitpoints","_cargoContainers"];

_vehicleID = _this;
_data = format ["loadVGVehicle:%1", _vehicleID] call ExileServer_system_database_query_selectSingle;
...
_cargoContainers = format ["loadVGVehicleContainer:%1", _vehicleID] call ExileServer_system_database_query_selectSingle;
...
format ["deleteVehFromVG:%1", _vehicleID] call ExileServer_system_database_query_fireAndForget;	
_vehicleObject