...
if (_vehicleID > -1) then
{
	...
	_currentLoadout = _vehicleObject call ExileExpansionServer_object_vehicle_getLoadout;
	_data =
	[
	...
	_extDB3Message = ["updateVehicle", _data] call ExileServer_util_extDB2_createMessage;
