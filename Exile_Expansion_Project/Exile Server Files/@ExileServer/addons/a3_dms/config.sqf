...
/* Mission System Settings */
	...
	DMS_PlayerNotificationTypes =		[									// Notification types. Supported values are: ["dynamicTextRequest", "standardHintRequest", "systemChatRequest", "textTilesRequest", "ExileToasts"]. Details below.
											//"dynamicTextRequest",			// You should use either "dynamicTextRequest" or "textTilesRequest", and I think "NORMAL" looks better, but this is less performance-intensive.
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_assault_googles =				[	// Eyewear/Facemask Class
	...
	DMS_MG_googles =					[	// Eyewear/Facemask Class
											"G_Respirator_white_F",
											"G_Respirator_yellow_F",
											"G_Respirator_blue_F"
										];
	...
	DMS_sniper_googles =				[	// Eyewear/Facemask Class
											"G_Respirator_white_F",
											"G_Respirator_yellow_F",
											"G_Respirator_blue_F"
										];
	//IMS Class
	DMS_IMS_weps =						[							// Weapons for IMS Class 
											#ifdef GIVE_AI_MARKSMAN_DLC_WEAPONS
											"MMG_01_hex_F",
											"MMG_02_black_F",
											#endif
	...
	DMS_IMS_pistols =					[							// Pistols for IMS Class (Set to empty array if you don't want to give them any pistols)
											"hgun_P07_F"
										];
	DMS_IMS_optics =					[							// Optics for IMS Class
											#ifdef GIVE_AI_APEX_GEAR
											"optic_SOS_khk_F",
											"optic_DMS_ghex_F",
											"optic_LRPS_tna_F",
	...
	DMS_IMS_optic_chance				= 100;						// Percentage chance that a IMS Class AI will get an optic
	DMS_IMS_bipod_chance				= 90;						// Percentage chance that a IMS Class AI will get a bipod
	DMS_IMS_suppressor_chance			= 15;						// Percentage chance that a IMS Class AI will get a suppressor

	DMS_IMS_items =						[							// Items for IMS Class AI (Loot stuff that goes in uniform/vest/backpack)
											"Exile_Item_InstaDoc",
											"Exile_Item_Surstromming_Cooked",
											"Exile_Item_PlasticBottleFreshWater",
											"Exile_Item_PlasticBottleFreshWater",
	...
	DMS_IMS_equipment =					[							// Equipment for IMS Class AI (stuff that goes in toolbelt slots)
											"Rangefinder",
											"ItemGPS"
										];
	DMS_IMS_RandItemCount =				3;							// How many random items to add to the AI's inventory.
	DMS_IMS_RandItems =					[							// The random items that will be added to the AI's inventory.
											"Exile_Item_EMRE",
											"Exile_Item_PlasticBottleCoffee",
											"Exile_Item_CanOpener",
											"Exile_Item_Instadoc",
	...
	DMS_IMS_helmets =					[							// Helmets for IMS Class
											"H_PASGT_basic_olive_F"
										];
	DMS_IMS_clothes =					[							// Uniforms for IMS Class
											"U_BG_Guerilla1_2_F"
										];
	DMS_IMS_vests =						[							// Vests for IMS Class
											"V_EOD_olive_F",
											"V_Pocketed_olive_F"
										];
	DMS_IMS_backpacks =					[							// Backpacks for IMS Class
											"B_Messenger_Olive_F"
										];
	DMS_IMS_googles =					[	// Eyewear/Facemask Class
											"G_Respirator_white_F"
										];
