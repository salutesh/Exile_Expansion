...
diag_log "----------------------------------------------------------------------------------------------------";
diag_log format['[Exile Expansion Server Addon] Loading server files..'];

["objects\CrateObjects"] call Exile_Expansion_CLS_fnc_ImportInteractionCrates;

diag_log format['[Exile Expansion Server Addon] Server files loaded!'];
diag_log "----------------------------------------------------------------------------------------------------";
